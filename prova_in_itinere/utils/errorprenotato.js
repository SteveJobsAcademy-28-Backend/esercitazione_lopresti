...
exports.errorprestito = errorprestito;
const prestito_1 = require("../models/prestito");
function errorprestito(isPrenotato, isdisponibile, datainizioPrestito, dataFinePrestito) {
    const prestito1 = new prestito_1.prestito(isPrenotato, datainizioPrestito, dataFinePrestito);
